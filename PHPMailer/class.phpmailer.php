...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'urgency.ragfreezone@gmail.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'RAG-FREE ZONE';
   ...
   * @var string
   */
  public $Sender            = 'urgency.ragfreezone@gmail.com';
   ...
   * @var string
   */
  public $Username      = 'urgency.ragfreezone@gmail.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'jcpxtbswtzihkuux';
